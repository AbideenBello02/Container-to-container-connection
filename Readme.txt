...
Another approach instead of referencing the container ip is by using a container network.
...
Docker will resolve the container address when a connection is made to it.